...
export default {
  ...
  form: {
    ...
    acceptance: 'Devi Accettare Le Condizioni',
    subject:'Oggetto',
    message: 'Messaggio',
    send:'Invia',
    required: 'Campo Richiesto',
    email: 'Inserisci un indirizzo Email Valido',
    check:'Acconsento al trattamento dei dati personali ai sensi del D.Lgs. 196/03',
    privacy: ` La informiamo che i dati da Lei forniti verranno trattati nell'ambito della nostra banca dati
  ...
  seo: 'L\'agriturismo Sant\'Alfonso è situato a Furore, splendido comune della Costiera Amalfitana. La struttura è immersa nel verde, tra colori ed i profumi della macchia mediterranea, rappresentando un\'oasi di pace ideale per trascorrere una vacanza all\'insegna della tranquillità.'
