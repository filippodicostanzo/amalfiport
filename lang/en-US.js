...
export default {
  ...
  title: {
    website: 'Porto di Amalfi - Marina Coppola',
    about: 'about',
    history: 'history',
    excursions: 'excursions',
  ...
  form: {
    fullname: 'Full Name',
    acceptance: 'You must accept the conditions',
    subject: 'Subject',
    message: 'Message',
    send: 'Send',
    required: 'Field Required',
    email: 'Enter A valid Email Address',
    check: ' I agree according to the European Regulation GDPR 679/2016',
    privacy: `We hereby inform you that your personal information and data will be handled in our electronic and/or paper archives, in strict compliance with the measures laid down by the european regulation GDPR 679/2016. We hereby guarantee that all data and information will be treated as strictly confidential and handled for the purpose to supply you with the requested information. Mandatory fields are required and must be filled in completely, otherwise it will be impossible for us to supply you with the detailed and correct information. Your personal data and information will be treated by our booking staff and will be cancelled at end of the season, unless a reservation had been done. For information about your personal information please contact us; Holder of the data processing is:`
  },
  ...
  seo: 'The Agriturismo Sant\'Alfonso is located in Furore, a wonderful town of the Amalfi coast, surrounded by the colours and scents of the Mediterranean vegetation. It is as an oasis of peace for relaxing and peaceful vacations.'
}
