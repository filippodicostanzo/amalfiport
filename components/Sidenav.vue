  ...
  <div>
    ...
    <div class="b-sidebar-right b-sidebar" ref="sidemenu">
        ...
        <client-only>
          <b-nav-item>
            <nuxt-link :to="localePath('/')" tag="a">
              <span @click="$nuxt.$emit('close-sidemenu')" exact class="text-uppercase">Home</span>
            </nuxt-link>
          </b-nav-item>
          <b-nav-item v-for="item in menu" :key="item.slug">
            <nuxt-link :to="localePath(item.slug)" tag="a">
              <span @click="$nuxt.$emit('close-sidemenu')" exact class="text-uppercase">{{
                  $t('menu.' + item.name)
                }}</span>
            </nuxt-link>
          </b-nav-item>
      ...
      <div class="lang-box text-center mt-4">
        <div class="language">
          <ul>
            <li><a href="https://www.instagram.com/marinacoppola_amalfi/" target="_blank"><i
              class="flaticon-instagram-logo"></i></a></li>
            <li><a href="https://www.facebook.com/portoamalfi/" target="_blank"><i class="flaticon-facebook"></i></a>
            </li>
          </ul>
        </div>
      </div>
